...
DatasetSizeSourcePurpose**Crash-1500**1500 videosInternalBaseline dataset**Euro NCAP**100 videosYouTube (official crash tests)Controlled test environment**V2X-Seq-SPD**100 videosGoogle Drive (DAIR-V2X)Real-world Chinese traffic
...
- \[x\] **Stage 3 (Crash-1500 label-bias):** mean-level + frame-level statistics → output/stage3/REPORT.md
- \[x\] **Stage 4 (Euro NCAP generative):** VLM-grounded descriptions → Veo video generation → ViT-L/14 CLIPScores → label-bias findings → output/stage4/REPORT.md
...
- **Report:** `output/stage3/REPORT.md`. Figures 1-5 (mean-level) + 6-9 (per-frame).
...
- **Report:** `output/stage4/REPORT.md`. Figures 10-12 (token bias, own-score, token confusion).

---

## 📖 Documentation

DocumentPurpose[**CLAUDE.md**](CLAUDE.md)Complete experiment workflow (3 datasets)**docs/PIPELINE_GUIDE.md**Technical implementation details**docs/QUICKSTART.md**Quick reference commands**docs/STATUS.md**Detailed progress tracker
...
**Last Updated:** 2026-04-21 **Status:** Active Development